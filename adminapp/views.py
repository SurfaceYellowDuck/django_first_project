...
from adminapp.forms import CategoryForm, ProductForm, AdminOrderItemEditForm, AdminOrderForm, ProductCategoryEditForm
...
def product_is_active_product_category_save(sender, instance, **kwargs):
    if instance.pk:
